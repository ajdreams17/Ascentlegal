...
export const metadata = {
  ...
  description:
    "Guides and practical playbooks for creators, founders, and growing businesses.",
...
const downloads = [
  // Consider swapping this out later if it’s not a priority audience
  {
  ...
  // Creator-first download (link can be placeholder until you upload)
  {
    ...
    <article className="group rounded-2xl border border-gray-100 bg-white p-6 hover:shadow-sm transition-shadow">
      ...
      <div className="mt-4">
        {g.comingSoon ? (
          ...
          <Link href={`/resources/${g.slug}`} className="text-sm font-medium text-indigo-600 hover:underline">
            Read more →
          </Link>
        )}
      </div>
...
export default function ResourcesPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-16">
      ...
      {/* Topic sections (anchors for UX + SEO) */}
      <section className="mt-16 space-y-16">
        ...
        <div id="copyright" className="scroll-mt-24">
          ...
          <div className="mt-6">
            <Link href="/services/copyright" className="text-sm font-medium text-indigo-600 hover:underline">
        ...
        <div id="brand-deals" className="scroll-mt-24">
          ...
          <div className="mt-6">
            <Link href="/services/entertainment" className="text-sm font-medium text-indigo-600 hover:underline">
        ...
        <div id="formation" className="scroll-mt-24">
          ...
          <div className="mt-6">
            <Link href="/services/corporate-formation" className="text-sm font-medium text-indigo-600 hover:underline">
          ...
          {downloads.map((d) => (
            ...
            >
              ...
              <div>
                ...
                {d.comingSoon ? (
                  <span className="mt-3 inline-block text-sm font-medium text-gray-500">
                    Download soon →
                  </span>
                ) : (
                  <a
