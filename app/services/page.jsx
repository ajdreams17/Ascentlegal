...
const inclusions = [
  ...
  },
  {
    ...
    desc: "From scratch drafting for deal types you run repeatedly (or one-off custom deals).",
  },
  {
...
export default function DealDeskSupportPage() {
  return (
    <main className="mx-auto max-w-7xl px-6 py-16">
      ...
      {/* WHAT'S INCLUDED */}
      <section className="mt-16" id="included">
          ...
          {[
            {
              ...
              text: "We confirm the deal type, timing, and goals so scope is clear.",
            },
            {
              step: "2",
              title: "Review + Strategy",
              text: "You get redlines plus a plain-English summary of risks and priorities.",
            },
            {
              step: "3",
              title: "Negotiate + Close",
              text: "We provide negotiation language and finalize clean terms for signature.",
            },
          ].map((p) => (
        ...
        <div className="grid md:grid-cols-2 gap-6 items-center">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Flat fees for common reviews and scoped estimates for complex deals. We’ll confirm the scope up front.
            </p>
          </div>
