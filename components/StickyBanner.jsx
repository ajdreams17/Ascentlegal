    ...
    <div className="al-banner">
      <div className="al-banner-left">
        ...
        <p className="al-banner-text">
          <strong>The 7 Mistakes That Kill New Trademarks</strong> — Download the free guide before you file.
        </p>
      </div>
      <a href="https://www.ascentlegal.io/trademark-guide" className="al-banner-cta">
        Get the Free Guide
