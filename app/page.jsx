        ...
        <div className="mx-auto max-w-7xl px-6 py-12 grid sm:grid-cols-2 md:grid-cols-4 gap-8 text-sm">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-gray-600">
              <li><button onClick={() => onNavigate("about")} className="hover:text-indigo-600">About</button></li>
              <li><button onClick={() => onNavigate("services")} className="hover:text-indigo-600">Practice Areas</button></li>
              <li><button onClick={() => onNavigate("resources")} className="hover:text-indigo-600">Resources</button></li>
            </ul>
          </div>
          <div>
